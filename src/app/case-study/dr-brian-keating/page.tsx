...
export default function DrBrianKeatingCaseStudy() {
  const [selectedImg, setSelectedImg] = useState<string | null>(null);

  const resultImages = [
    'brain-yt-1.jpg', 'brain-yt-2.jpg', 'brain-yt-3.jpg', 
    'brain-yt-4.jpg', 'brain-yt-5.jpg', 'brain-yt-6.jpg',
    'brain-shorts-1.jpg', 'brain-shorts-2.jpg', 
    'brain-shorts-3.jpg', 'brain-shorts-4.jpg'
  ];
    ...
    <main style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ width: '100%', height: '60vh', minHeight: '400px', position: 'relative', display: 'flex', alignItems: 'flex-end' }}>
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1 }}>
          <img src="/images/case-studies/brian.jpg" alt="Dr. Brian Keating Background" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
        ...
        <div style={{ padding: '0 5vw', width: '100%', maxWidth: '1200px', margin: '0 auto', paddingBottom: '3rem' }}>
          ...
          <h1 className={styles.sectionTitle} style={{ fontSize: 'clamp(3.5rem, 7vw, 7rem)', margin: 0, color: 'white', textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>Dr. Brian Keating</h1>
        </div>
      </div>
      ...
      <div style={{ maxWidth: '800px', margin: '4rem auto 0 auto', padding: '0 5vw' }}>
        <div style={{ color: 'rgba(255,255,255,0.8)', fontSize: '1.2rem', lineHeight: '1.8' }}>
          <p style={{ marginBottom: '2rem' }}>
            We are proud to have significantly contributed to the growth of the Dr. Brian Keating YouTube channel. Through our strategic approach, tailored content, and targeted marketing efforts, we helped Dr. Brian Keating achieve 615% more views than usual.
          </p>
          <p style={{ marginBottom: '2rem' }}>
            Our data-driven strategies have played a pivotal role in achieving this remarkable milestone. We look forward to continuing our partnership and further enhancing the success of the Dr. Brian Keating YouTube channel.
          </p>
          <a href="https://www.youtube.com/DrBrianKeating" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', color: '#ff0000', fontWeight: 'bold', textDecoration: 'none', border: '1px solid rgba(255,0,0,0.3)', padding: '0.8rem 1.5rem', borderRadius: '50px', background: 'rgba(255,0,0,0.05)', marginTop: '0.5rem', marginBottom: '1rem', transition: 'all 0.3s ease' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto 10vw auto', padding: '0 5vw' }}>
              ...
              <div className="styled-box problem-box">
                ...
                <ul className="box-list">
                  {[
                    ...
                    "Not using shorts to get visibility on podcasts."
                  ].map((item, i) => (
                    <li key={i}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
            {resultImages.map((imgName, i) => {
              const imgSrc = `/images/case-studies/dr-brian-results/${imgName}`;
              return (
                <div key={i} style={{ position: 'relative', width: '100%', aspectRatio: '16/9', overflow: 'visible', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <img 
                    src={imgSrc} 
                    alt={`Result ${i + 1}`} 
